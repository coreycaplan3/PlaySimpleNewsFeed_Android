...
public class FabTransform extends Transition {
    ...
    /**
     * Create a {@link FabTransform} from the supplied {@code activity} extras and
     * set as shared element enter/return transition.
     *
     * @return True if the proper arguments were sent to the given activity via INTENT or false if
     * there was no transition information supplied.
     */
    public static boolean isSetup(@NonNull Activity activity, @Nullable View target) {
    ...
    public Animator createAnimator(final ViewGroup sceneRoot,
        ...
        final Interpolator fastOutSlowInInterpolator =
                AnimationUtility.getFastOutSlowInInterpolator(sceneRoot.getContext());
        ...
        if (fromFab) {
            ...
            circularReveal.setInterpolator(
                    AnimationUtility.getFastOutLinearInInterpolator(sceneRoot.getContext()));
        } else {
            circularReveal = ViewAnimationUtils.createCircularReveal(view,
                    view.getWidth() / 2,
                    view.getHeight() / 2,
                    ...
                    endBounds.width() / 2);
            circularReveal.setInterpolator(
                    AnimationUtility.getLinearOutSlowInInterpolator(sceneRoot.getContext()));
        ...
        return new AnimationUtility.NoPauseAnimator(transition);
    }
